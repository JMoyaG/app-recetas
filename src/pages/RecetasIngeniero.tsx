    ...
    try {
      ...
      const payload = {
        ...
        productos: productosSeleccionados.map((item) => ({
          ...
          inventarioMomento: Number(item.disponible ?? item.stock ?? 0),
          disponibleMomento: Number(item.disponible ?? item.stock ?? 0),
          stockMomento: Number(item.stock ?? item.disponible ?? 0),
          reservadaMomento: Number(item.reservada ?? 0),
